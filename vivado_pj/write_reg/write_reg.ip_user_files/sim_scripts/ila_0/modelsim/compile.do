...
vlog -work xpm  -incr -mfcu  -sv "+incdir+../../../../write_reg.gen/sources_1/ip/ila_0/hdl/verilog" \
...
vlog -work xil_defaultlib  -incr -mfcu  "+incdir+../../../../write_reg.gen/sources_1/ip/ila_0/hdl/verilog" \
